...
New_Blood_Lead_Children %>%
  ...
  labs(x = "Year", y = "BLL >= 5 Per 1,000", color = "Boroughs", caption = "Rate of Kids below the age of six who had greater than or equal to 5 mcg/dL uelavated") +
  theme_gray()
...
New_Blood_Lead_Children %>%
 ...
 ggplot() +
  ...
  scale_x_continuous(breaks = seq(2005, 2016, 1)) +
  labs(x = "Year", y = "BLL >= 10 Per 1,000", color = "Boroughs", caption = "Rate of Kids below the age of six who had greater than or equal to 10 mcg/dL uelavated") +
  theme_gray()
...
New_Blood_Lead_Children %>%
  ...
  scale_x_continuous(breaks = seq(2005, 2016, 1)) +
  labs(x = "Year", y = "BLL >= 15 Per 1,000", color = "Boroughs", caption = "Rate of Kids below the age of six who had greater than or equal to 15 mcg/dL uelavated") +
  theme_gray()
