...
## *Background*\
For this data we are talking about the amount of tested blood lead levels in each borough in New York City. This is imporatant because it is concerning the total amount of blood lead levels present in children and it is also interesting to look and compare the total amount of levels in each different boroughs. According to the CDC, any Blood Lead Level over micrograms per deciliter (mcg/dL) is considered toxic. Elevated Blood Lead Levels can lead to numerous negative health effects, such as brain damage, slowed developmental growth, and damage to the nervous system. According to NYC Health lead is found in old paint and that lead paint turns into dust, which is usually what is found in children. What we don’t know about yet is what makes each borough so different? Some of the boroughs are maybe  30 minutes apart from eachother and they still present different total amount of blood lead levels in children. There are muliple variables in which factors why some boroughs have larger or smaller amount blood lead levels, but one major factor we determined is socioeconomic status. Children from low-income families may be at higher risk due to living conditions such as, living in older, poorly maintained housing with lead hazards, lack of access to healthcare and proper nutrition, and exposure to other environmental pollutants. We are hoping to see some correlation between the poverty levels in each borough to the amount of blood lead level in children. (https://www.cdc.gov/nceh/lead/prevention/health-effects.htm) (https://www.nyc.gov/site/doh/health/health-topics/lead-poisoning-prevention.page)
...
```
Our tables show that out hypothesis was not entirely correct, we anticipated that the boroughs with the most rates of poverty would also have the highest rates of elevated Blood Lead Levels in Chidren. If our hypothesis was correct, the Bronx would have the higest rates of positive tests due to its heightened rate of poverty. However, we found that there still may seem to be some correlation between poverty rates and percent of positive tests per borough. Staten Island has consistently had the lowest levels of Evelvated Blood Lead levels as well as the lowest rates of poverty. This may prove a positive relationship between between poverty level and positive tests.
