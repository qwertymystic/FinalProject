...
New_Blood_Lead_Children %>%
  ...
  labs(x = "Year", y = "BLL >= 5 mcg/dL Per 1,000", color = "Boroughs", caption = "Rate of Kids below the age of six who had greater than or equal to 5 mcg/dL elavated Blood Lead Levels") +
  theme_gray() +
  theme(plot.caption = element_text(hjust = .2), axis.text.x = element_text(angle = 45))
